	...
	{	
		...
		results +=  (myDate.getMonth() + 1) +"/"+ myDate.getDate() + "/" + myDate.getFullYear() + "-" + myDate.getHours() + ":" + myDate.getMinutes() + ":" + appendLeadingZeroes(myDate.getSeconds()) + " - " + name + " , " + branch + "  " + ", " + startYear; 
